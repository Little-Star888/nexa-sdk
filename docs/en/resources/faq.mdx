...
<AccordionGroup>
  ...
  <Accordion title="How do I set a Hugging Face token for gated models?">
    Some Hugging Face models require you to accept a license and authenticate. Set the `HF_TOKEN` environment variable:
    ...
    Get your token at [huggingface.co/settings/tokens](https://huggingface.co/settings/tokens). For full setup steps, see [Set up a Hugging Face token](/en/models/supported#set-up-a-hugging-face-token).
  </Accordion>
