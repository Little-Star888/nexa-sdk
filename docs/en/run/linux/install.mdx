...
- Credentials with read access to the container registry.

### **Pull the image**

Authenticate to the Qualcomm Container Registry, then pull:
...
docker pull docker-registry.qualcomm.com/qcom-ai-hub/geniex-cli:latest
```
...
docker run -it --rm --privileged \
  ...
  docker-registry.qualcomm.com/qcom-ai-hub/geniex-cli:latest
```
