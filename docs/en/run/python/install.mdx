...
<Tabs>
  ...
  <Tab title="Linux ARM64">
    ...
    <Note>
    If Python is not pre-installed on your device, install it via Miniconda or `apt` (Ubuntu). See [How do I install Python on a Linux ARM64 device?](/en/resources/faq#how-do-i-install-python-on-a-linux-arm64-device) in the FAQ.
    </Note>
  </Tab>
</Tabs>
